...
return [
    'files' => [
        [
            ...
            // Merged at runtime by DocsController; per-module sources live under Modules/*/resources/swagger/ and resources/swagger/App-swagger.json.
            'versions' => [
            ...
            // Specify the validator URL. Set to null to disable validation.
