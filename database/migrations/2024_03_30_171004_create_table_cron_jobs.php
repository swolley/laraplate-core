...
return new class() extends Migration
{
    ...
    {
        $cron_jobs_table = CoreTables::CronJobs->value;
        Schema::create($cron_jobs_table, function (Blueprint $table) use ($cron_jobs_table): void {
            $table->id();
            ...
            $table->boolean('is_active')->nullable(false)->index("{$cron_jobs_table}_is_active_IDX")->comment('Is the cron job active');
    ...
    {
        Schema::dropIfExists(CoreTables::CronJobs->value);
    }
};
